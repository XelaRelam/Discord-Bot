 ...
 * @returns {boolean}
 *  ↳ True if the bot has SendMessages permissions, otherwise false.
 */
export const botHasSendPerms = (
  client: Client,
  channel: TextChannel,
): boolean => {
  if (!channel) return false;
 ...
 *  ↳ The ID of the channel to check.
 * @returns {boolean}
 *  ↳ True if the bot has EmbedLinks permissions, otherwise false.
 */
export const botHasEmbedPerms = (
  client: Client,
  channel: TextChannel,
): boolean => {
  if (!channel) return false;
 ...
 *  ↳ The ID of the channel to check.
 * @returns {boolean}
 *  ↳ True if the bot has ReadMessageHistory permissions, otherwise false.
 */
export const botHasHistoryPerms = (
  client: Client,
  channel: TextChannel,
): boolean => {
  if (!channel) return false;
 ...
 *  ↳ The ID of the channel to check.
 * @returns {boolean}
 *  ↳ True if the bot has ViewChannel permissions, otherwise false.
 */
export const botHasViewPerms = (
  client: Client,
  channel: TextChannel,
): boolean => {
  if (!channel) return false;
